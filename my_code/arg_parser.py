...
def get_wandb_name(args):
    wandb_name = "method_{0}_epochs_{1}_unlearnlr_{2}_seed_{3}".format(
        args.unlearn,
        args.unlearn_epochs,
        args.unlearn_lr,
        args.seed,
...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="femnist", help="dataset")
    parser.add_argument(
    ...
    parser.add_argument("--gold_model_path", type=str, default=None, help="the path of gold model")
    ##################################### Training setting #################################################
    ...
    parser.add_argument("--with_seb_loss",action='store_true',default =False, help="use seb loss")
    parser.add_argument("--with_cross_entropy",action = 'store_false',default=True, help="use crossentropy loss")
    parser.add_argument("--gamma", default=0.1, type=float, help="gamma for lr scheduler")
    parser.add_argument("--ratio_forget_retain", default=1, type=float, help="ratio of forget and retain")
